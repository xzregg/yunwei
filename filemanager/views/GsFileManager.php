...
class GSFileSystemFileStorage():
	...
	def deleteDirectory(self,dirname):
		if dirname and  self.is_dir(dirname):
			shutil.rmtree(dirname)
			return True
		return False

	def makeDirectory(self,dirname):
		if not self.file_exists(dirname):
			os.mkdir(dirname);
			return True
		return False
	...
	def  copyFile(self,from, to):
		if not self.file_exists(to):
			shutil.copy(from, to)
			return True
		return False
