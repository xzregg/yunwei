...
d1 = {
	'default': {
		...
		'PORT': '3306',	
		'unix_socket':'/tmp/mysql.sock'				  # Set to empty string for default. Not used with sqlite3.
	},
}
d2 = {
	'default': {
		'ENGINE': 'sqlite3', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
		'NAME': PWD+'yunwei.db',					  # Or path to database file if using sqlite3.
...
try:
	d=d1['default']
	conn=MySQLdb.connect(host=d['HOST'],port=int(d['PORT']),user=d['USER'],passwd=d['PASSWORD'],db=d['NAME'])
	DATABASES=d1
